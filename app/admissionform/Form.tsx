...
const schema = yup.object().shape({
  ...
  class: yup.string().oneOf(['9th', '10th', '11th', '12th', '13th', '14th', '15th', '16th', '17th', '18th', 'None'], 'Invalid class').required('Class is required'),
  stream: yup.string().oneOf(['English', 'Hindi', 'Semi-Urdu', 'Semi-Marathi', 'Art', 'Commerce', 'Science'], 'Invalid stream').required('Stream is required'),
...
const Form: React.FC = () => {
  ...
  const [submitForm, { isLoading }] = useGetFormMutation();
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="mb-4">
            ...
            >
              ...
              {['9th', '10th', '11th', '12th', '13th', '14th', '15th', '16th', '17th', '18th', 'None'].map((option) => (
          ...
          <div className="mb-4">
            ...
            >
              ...
              {['English', 'Hindi', 'Semi-Urdu', 'Semi-Marathi', 'Art', 'Commerce', 'Science'].map((option) => (
                <option key={option} value={option}>{option}</option>
              ))}
            </select>
          ...
          <div className="mb-4">
            ...
            >
              ...
              {['Jr. College', 'Degree / Master Courses', 'None'].map((option) => (
                <option key={option} value={option}>{option}</option>
              ))}
            </select>
