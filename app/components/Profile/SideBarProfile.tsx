    ...
    <div className="w-full">
      ...
      >
        <Image
          ...
          width={20}
          height={20}
          className="w-[20px] h-[20px] 800px:w-[30px] 800px:h-[30px] cursor-pointer rounded-full font-Poppins border-[2px] border-[#37a39a]"
        />
      ...
      >
        ...
        <h5 className="pl-2 800px:block hidden cursor-pointer font-Poppins">Change Password</h5>
      </div>
      <div
      ...
      >
        ...
        <h5 className="pl-2 800px:block hidden cursor-pointer font-Poppins">Enrolled Courses</h5>
      </div>
      {user.role === 'admin' && (
        <Link
          className={`w-full flex items-center px-3 py-4 cursor-pointer ${active === 6 ? 'bg-slate-800' : 'bg-transparent'}`}
          href={"/admin"}
        >
          <MdOutlineAdminPanelSettings size={20} fill="#fff" />
          <h5 className="pl-2 800px:block hidden cursor-pointer font-Poppins">Admin Dashboard</h5>
        </Link>
      )}
      <div
