...
import avatarDefault from "../../../../public/assets/avt1.jpeg";
            ...
            <ProSidebar collapsed={isCollapsed} style={{ position: "fixed", top: 0, left: 0, height: "100vh", width: isCollapsed ? "0%" : "16%" }}>
                <Menu iconShape="square">
                    ...
                    >
                        {!isCollapsed && (
                            <Box display="flex" justifyContent="space-between" alignItems="center" ml="15px">
                                <Link href="/">
                                    <h3 className="text-[25px] font-Poppins uppercase dark:text-white text-black">    Garuda</h3>
                                </Link>
                    ...
                    {!isCollapsed && (
                        <Box mb="25px">
                            ...
                            <Box textAlign="center">
                                <Typography variant="h4" className="!text-[20px] text-black dark:text-[#ffffffc1]" sx={{ m: "10px 0 0" }}>
                                    {user?.name}
                                </Typography>
                                <Typography variant="h6" sx={{ m: "10px 0 0" }} className="text-[20px] text-black dark:text-[#ffffffc1] capitalize">
                                    {user?.role}
                                </Typography>
                            </Box>
                        </Box>
                    ...
                    <Box paddingLeft={isCollapsed ? undefined : "10%"}>
                        ...
                        <Typography variant="h5" sx={{ m: "15px 0 5px 20px" }} className="!text-[18px] text-black dark:text-[#ffffffc1] capitalize font-[400] ">
                            {!isCollapsed && "Content"}
                        </Typography>
                        ...
                        <Typography variant="h6" sx={{ m: "15px 0 5px 20px" }} className="!text-[18px] text-black dark:text-[#ffffffc1] capitalize font-[400] ">
                            {!isCollapsed && "Extras"}
                        </Typography>
