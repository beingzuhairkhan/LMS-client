...
const DashboardHeader: FC<Props> = ({ open, setOpen }) => {
    ...
    return (
        <div className="w-full flex items-center justify-center p-6 fixed top-5 right-8">
            <ThemeSwitcher />
            <div className=" relative flex items-center cursor-pointer m-2" onClick={() => setOpen && setOpen(!open)}>
                    ...
                    <div className="w-[350px] h-[50vh] dark:bg-[#111C43] bg-white shadow-xl absolute top-16 z-10 rounded ">
                        ...
                        <div className="overflow-y-auto h-full">
                            {notifications.map((item: any, index: number) => (
                                <div key={index} className="dark:bg-[#2d3a4ea1] bg-[#00000013] font-Poppins border-b dark:border-b-[#ffffff47] border-b-[#00000001] p-2">
