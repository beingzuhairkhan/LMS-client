...
const CoursePreview: FC<Props> = ({ active, setActive, courseData, handleCourseCreate , isEdit}) => {
  const estimatedPrice = courseData?.estimatedPrice;
      ...
      <div className="w-full relative">
        ...
        <div className="flex items-center">
          <input
            ...
            className={`${style.input} 1500px:!w-[50%] 1100px:w-[60%] my-3 ml-4 font-Poppins cursor-pointer`}
          />
          <div className={`${style.button} !w-[120px] my-3 font-Poppins cursor-pointer`}>
            Apply
          </div>
        </div>
