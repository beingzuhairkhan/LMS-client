...
const CourseContentList: FC<Props> = ({ data, activeVideo, setActiveVideo, isDemo }) => {
    ...
    let totalCount: number = 0; // total count of videos for previous sections
    ...
    return (
        <div className={`mt-[15px] w-full ${!isDemo && 'ml-[-30px] sticky top-24 left-0 z-30'}`}>
            {videoSections.map((section: string, sectionIndex: number) => {
                ...
                return (
                    <div className={`${!isDemo && 'border-b border-[#ffffff8e] pb-2'}`} key={sectionIndex}>
                        ...
                        <h5 className="text-black dark:text-white">
                            {sectionVideoCount} Lesson{sectionVideoCount !== 1 ? 's' : ''}. {sectionVideoLength < 60 ? sectionVideoLength : sectionContentHours.toFixed(2)}{' '}
                                    ...
                                    return (
                                        ...
                                        >
                                            <div className="flex items-start">
                                                ...
                                                <h1 className="text-[18px] inline-block text-black dark:text-white">{item.title}</h1>
                                            </div>
